...
import test.components.AppTestManager;
...
public class  StepsSampleScreenFunctional{
    ...
    public void setUp(){
	    ...
	    @Given("^I use the (.+) browser in Scenario1:$")
	    public void i_use_the_browser_in_scenario1(String browser) throws Throwable {
	    	if (appTestManager!=null) {
				appTestManager.closeTest();
			}
	    	appTestManager = new AppTestManager();
	    	appTestManager.setBrowser(browser);
			appTestManager.initBrowser();
	    }
	
		@And("^I am using \"([^\"]*)\" to navigate to the Home page$")
	    public void i_am_using_something_to_navigate_to_the_home_page(String strArg1) throws Throwable {
	 	...
	 	@Given("^I use the (.+) browser in Scenario2:$")
	    public void i_use_the_browser_in_scenario2(String browser) throws Throwable {
	 		if (appTestManager!=null) {
				appTestManager.closeTest();
			}
	    	appTestManager = new AppTestManager();
	 	 ...
	 	 @And("^I am using \"([^\"]*)\" to navigate to the about page$")
	     ...
	     @Given("^I use the (.+) browser in Scenario3:$")
	     public void i_use_the_browsers_in_scenario3(String browser) throws Throwable {
	    	 if (appTestManager!=null) {
					appTestManager.closeTest();
				}
		    	appTestManager = new AppTestManager();
	     ...
	     @And("^I am using \"([^\"]*)\" to navigate to the contact page$")
