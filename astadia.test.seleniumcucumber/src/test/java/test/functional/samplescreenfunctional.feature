...
Scenario: Add two numbers in home apge and navigate to about page
	Given I am using "http://192.168.1.78:97/" to navigate to the Home page
...
Scenario: Add two numbers in about page and then navigate to contact page
	Given I am using "http://192.168.1.78:97/Home/About" to navigate to the about page
...
Scenario: Add two numbers in contact page and finish
	Given I am using "http://192.168.1.78:97/Home/Contact" to navigate to the contact page
