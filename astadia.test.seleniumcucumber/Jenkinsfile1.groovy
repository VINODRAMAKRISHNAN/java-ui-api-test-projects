	...
	stages{
		stage('Clean and Checkout'){
			steps{
				...
				cleanWs();	
				checkout([$class: 'GitSCM', branches: [[name: '*/'+ env.ENV_BRANCH]], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '0f74659a-05e0-4f91-bd01-ff78f95820e5', url: '' + env.ENV_URL]]])
